...
let UpdateProduct = class UpdateProduct {
    ...
    updateProduct(id, dataInput) {
        return __awaiter(this, void 0, void 0, function* () {
            const product = yield this.productRepository.findOne(id);
            if (!product) {
                throw new apollo_server_express_1.ApolloError("Product is not found");
            }
            ...
            this.productRepository.merge(product, Object.assign(Object.assign({}, dataInput), { category: category }));
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, CreateProductInput_1.CreateProductInput]),
    __metadata("design:returntype", Promise)
], UpdateProduct.prototype, "updateProduct", null);
